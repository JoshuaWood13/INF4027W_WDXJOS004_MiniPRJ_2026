    ...
    <header className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          ...
          >
            Browse top laptop brands for gaming, business, study, or everyday
            use. Compare specs, find deals, and get the perfect machine
        ...
        <motion.section
          ...
          className="relative md:px-4 min-h-[448px] md:min-h-[428px] bg-contain bg-[center_top] bg-no-repeat bg-[url('/images/laptop-hero.webp')]"
        >
          <Image
            priority
